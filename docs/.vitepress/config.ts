...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'Home', link: '/' },
      { text: 'Guide', link: '/v1/introduction/what-is-anonymizer' },
    ],
    ...
    sidebar: [
      {
        text: 'Introduction',
        items: [
          { text: 'What is Anonymizer', link: '/v1/introduction/what-is-anonymizer' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Anonymize Models', link: '/v1//guide/basic/anonymize-models' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/yormy/anonymizer-laravel' }
    ]
  }
